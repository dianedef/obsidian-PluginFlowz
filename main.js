...
function registerStyles() {
  ...
  styleEl.textContent = `
    ...
    /* Cibler la barre de progression elle-m\xEAme */
    .progress-container > div {  /* Le conteneur cr\xE9\xE9 par Obsidian */
...
var ViewMode = class {
  ...
  createRatingControl(container, plugin, isCard = false) {
    if (isCard) {
      ...
      const progressBar = new import_obsidian4.ProgressBarComponent(progressContainer);
